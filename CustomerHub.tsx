                        ...
                        >
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center opacity-0 group-hover:opacity-100 lg:opacity-100 transition-opacity">
                                    <button onClick={(e) => {e.stopPropagation(); handleEdit(customer)}} className="p-1 text-slate-400 hover:text-teal-600 rounded-full"><PencilIcon className="w-4 h-4"/></button>
            ...
            <main className={`flex-1 p-4 sm:p-8 overflow-y-auto ${!selectedCustomer ? 'hidden lg:block' : 'block'}`}>
                ...
                {selectedCustomer ? (
                    <div className="space-y-8">
                        <button onClick={() => setSelectedCustomer(null)} className="lg:hidden flex items-center text-sm font-semibold text-teal-600 hover:text-teal-800 mb-4">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div className="flex items-center space-x-2">
                                     <div className="hidden sm:flex text-sm text-slate-500 items-center"><CalendarDaysIcon className="w-4 h-4 mr-1.5"/>마지막 방문: {new Date(selectedCustomer.lastVisit).toLocaleDateString()}</div>
