...
${medList}
## 요청 사항
위 정보를 바탕으로, 보호자가 이해하기 쉽고 친절한 말투로 복약 지도문을 생성해주세요. 각 약물별 복용법과 주의사항을 명확히 구분하고, 일반적인 생활 수칙과 당부사항을 포함하여 안심할 수 있는 메시지를 전달해주세요. 반드시 아래 JSON 스키마에 맞춰 응답해주세요. 마크다운 문법(**, # 등)을 사용하지 마세요.
